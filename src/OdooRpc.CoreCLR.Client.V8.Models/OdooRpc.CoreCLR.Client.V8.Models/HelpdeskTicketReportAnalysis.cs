...
public partial class HelpdeskTicketReportAnalysis
{
    ...
    public virtual double ticket_deadline_hours { get; set; }
    public virtual double ticket_close_hours { get; set; }
    public virtual double ticket_open_hours { get; set; }
    public virtual double ticket_assignation_hours { get; set; }
