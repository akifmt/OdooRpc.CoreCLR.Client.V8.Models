...
public partial class HrJob
{
    ...
    public virtual long expected_employees { get; set; }
    public virtual long no_of_employee { get; set; }
    public virtual long no_of_recruitment { get; set; }
    public virtual long[] employee_ids { get; set; }
    public virtual string description { get; set; }
    public virtual string requirements { get; set; }
    public virtual object department_id { get; set; }
    public virtual object company_id { get; set; }
    public virtual object contract_type_id { get; set; }
