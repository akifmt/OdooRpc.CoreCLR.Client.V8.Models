...
public partial class HrReferralReward
{
    ...
    public virtual long awarded_employees { get; set; }
    public virtual long points_missing { get; set; }
    public virtual string description { get; set; }
    public virtual object gift_manager_id { get; set; }
