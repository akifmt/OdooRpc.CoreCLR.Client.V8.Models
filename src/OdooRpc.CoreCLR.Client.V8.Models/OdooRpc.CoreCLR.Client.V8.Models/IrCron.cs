...
{
    public virtual object ir_actions_server_id { get; set; }
    public virtual string cron_name { get; set; }
    ...
    public virtual long numbercall { get; set; }
    public virtual bool doall { get; set; }
