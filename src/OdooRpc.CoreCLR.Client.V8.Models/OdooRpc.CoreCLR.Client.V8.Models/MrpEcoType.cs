...
public partial class MrpEcoType
{
    ...
    public virtual long nb_ecos { get; set; }
    public virtual long nb_approvals { get; set; }
    public virtual long nb_approvals_my { get; set; }
    public virtual long nb_validation { get; set; }
