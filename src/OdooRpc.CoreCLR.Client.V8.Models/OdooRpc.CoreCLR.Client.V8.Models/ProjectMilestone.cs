...
public partial class ProjectMilestone
{
    ...
    public virtual bool is_reached { get; set; }
    public virtual string reached_date { get; set; }
    public virtual long[] task_ids { get; set; }
    public virtual bool is_deadline_exceeded { get; set; }
    public virtual bool is_deadline_future { get; set; }
