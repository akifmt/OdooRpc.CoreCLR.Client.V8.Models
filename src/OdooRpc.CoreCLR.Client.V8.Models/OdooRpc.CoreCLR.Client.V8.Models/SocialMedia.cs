...
public partial class SocialMedia
{
    ...
    public virtual string media_description { get; set; }
    public virtual string image { get; set; }
    public virtual string media_type { get; set; }
    public virtual string csrf_token { get; set; }
    public virtual long[] account_ids { get; set; }
    public virtual long accounts_count { get; set; }
    public virtual bool has_streams { get; set; }
    public virtual bool can_link_accounts { get; set; }
    public virtual long[] stream_type_ids { get; set; }
    public virtual long max_post_length { get; set; }
