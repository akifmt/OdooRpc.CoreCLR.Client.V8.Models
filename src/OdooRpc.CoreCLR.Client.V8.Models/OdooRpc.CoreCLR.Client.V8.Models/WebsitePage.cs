...
public partial class WebsitePage
{
    ...
    public virtual long[] menu_ids { get; set; }
    public virtual bool is_in_menu { get; set; }
    public virtual bool is_homepage { get; set; }
    public virtual bool is_visible { get; set; }
    public virtual bool is_new_page_template { get; set; }
    public virtual bool header_overlay { get; set; }
    public virtual string header_color { get; set; }
    public virtual string header_text_color { get; set; }
